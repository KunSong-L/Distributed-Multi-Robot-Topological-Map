...
class RobotNode:
    ...
    def init_topomap(self):
        # receive topomap
        bag_path = "/home/master/topomap_data/fht_grid_rosbag/large_indoor/topoexplore/topomap_2023-08-28-21-04-10.bag"
        ...
        for topic, msg, t in bag.read_messages():
            ...
            if topic == "/robot1/topomap":
                for i in range(len(msg.vertex)):
                    ...
                    vertex.pose = [now_vertex.pose.pose.position.x - 10, now_vertex.pose.pose.position.y - 10, 0]
