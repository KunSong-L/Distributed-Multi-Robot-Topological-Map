...
class map_analysis:
    ...
    def get_time_call_back(self,data):
        ...
        if self.receive_time_num == 3: 
            ...
            process = subprocess.Popen("rosbag record --duration=10 -O "+ target_dir +" robot1/map robot2/map robot3/map __name:=my_bag", shell=True, env=os.environ) #change to your file path
            time.sleep(11)
