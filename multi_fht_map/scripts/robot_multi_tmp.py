...
class RobotNode:
    ...
    def visulize_vertex(self):
        ...
        # ----------visualize frontier------------
        now_vis_color = self.vis_color[0]
        ...
        frontier_marker.color.r = now_vis_color[0][0]
        frontier_marker.color.g = now_vis_color[0][1]
        frontier_marker.color.b = now_vis_color[0][2]
