...
options = {
  ...
  map_frame = "robot6/map",
  tracking_frame = "robot6/base_footprint", -- imu_link, If you are using gazebo, use 'base_footprint' (libgazebo_ros_imu's bug)
  published_frame = "robot6/odom",
  odom_frame = "robot6/odom",
  ...
  pose_publish_period_sec = 0.03333,
