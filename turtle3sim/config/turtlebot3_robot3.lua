...
options = {
  ...
  map_frame = "robot3/map",
  tracking_frame = "robot3/base_footprint", -- imu_link, If you are using gazebo, use 'base_footprint' (libgazebo_ros_imu's bug)
  published_frame = "robot3/odom",
