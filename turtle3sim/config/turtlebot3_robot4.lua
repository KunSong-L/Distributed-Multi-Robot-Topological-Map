...
options = {
  ...
  map_frame = "robot4/map",
  tracking_frame = "robot4/base_footprint", -- imu_link, If you are using gazebo, use 'base_footprint' (libgazebo_ros_imu's bug)
  published_frame = "robot4/odom",
  odom_frame = "robot4/odom",
